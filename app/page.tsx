							...
							<div className="flex flex-col justify-center mt-4">
								...
								<div className="mt-16 md:mt-8">
									<p className="text-normal">
										{
											"When I'm not writing code I'm riding my bike and when I'm not riding my bike I'm"
										}
									</p>
									<ul className="text-normal list-none list-inside">
										<li>
											{
												"- interested in backend, infrastructure and databases"
											}
										</li>
										<li>
											{
												"- skilled with Python, Go, Typescript, AWS, React, Django ... (more)"
											}
										</li>
										<li>
											{"- listening to: "}
