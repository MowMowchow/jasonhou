...
const jobs = [
    {
        ...
        tech: "Golang, TypeScript, React, HTML & CSS, Wails",
        description: [
            "Integrated with the GoPacket library to parse different (proprietary) ethernet protocols, allowing engineers to view more CAN data",
            "Created a tool to view different log file types (TRC, BLF, etc) with infinite scrolling",
            "People didn't like the old setup flow to configure devices for a tool, so I refactored it",
        ],
    },
    {
        name: "Carta",
        ...
        logo: "/carta.png",
        team: "Governance",
        tech: "Python, Typescript, Django, React",
        description: [
            "Implemented a bunch of features (actions on security consents) to maintain feature parity when migrating back from microservice -> monolith",
            "Scaffolded and constructed metrics in newly migrated services",
            "Various UI/UX improvements (top nav bar to side nav bar, new modals, etc)",
        ],
    },
    {
        name: "Carta",
        ...
        description: [
            "Refactored models for scalability and wrote corresponding event architecture",
        ...
        <div className="grid grid-cols-1">
            ...
            <div className="flex justify-center">
                <div className="w-fit">
                    ...
                    <div className="grid grid-cols-1 w-fit max-w-[64ch]">
                        {jobs.map((job) => (
